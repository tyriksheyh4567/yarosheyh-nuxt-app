	...
	<div>
		<UiCard class="mx-auto max-w-sm">
			<UiCardHeader>
				...
				<UiCardDescription> Введите свои данные для входа в систему. </UiCardDescription>
			</UiCardHeader>
			<UiCardContent>
				<div class="grid gap-4">
					...
					<UiButton type="submit" class="w-full" @click="handleSignIn()">
						Войти
					</UiButton>
					<UiButton
						variant="outline"
				...
				<div class="mt-4 text-center text-sm">
					Нет аккаунта?
					<NuxtLink to="/sign-up" class="underline"> Зарегистрироваться </NuxtLink>
				</div>
			</UiCardContent>
		</UiCard>
	</div>
